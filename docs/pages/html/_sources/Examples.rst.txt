...
.. code:: python
    ...
    model = undouble.fit_transform(X, y_true, pos_label='bad', train_test=True, gridsearch=True)
...
.. code:: python
    ...
    # Retrieve URLs of malicous and normal urls:
    model = undouble.fit_transform(X, y_true, pos_label='bad', train_test=False, gridsearch=True)
